const Nicknames = [
  {
    ...
    description: (gender = "M") =>
      gender == "M" ? "um guerreiro temido que destrói tudo em seu caminho." : "uma guerreira temida que destrói tudo em seu caminho.",
  },
];
...
const DefaultNickname = {
  ...
  description: (gender = "M") =>
    gender == "M"
      ? "o guerreiro que descobriu como alterar sua alcunha para uma inválida."
      : "a guerreira que descobriu como alterar sua alcunha para uma inválida",
};
